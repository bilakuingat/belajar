            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        " class="form-control" placeholder="Input disini" required>
                    </div>
                    <div class="form-group">
                        <label for="">NIM</label>
                        <input type="text" name="tnim" value="<?= @$vnim ?>
                            " class="form-control" placeholder="Input disini" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="talamat" class="form-control" placeholder="Input disini"><?= @$valamat ?>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?hal=hapus&id=<?= $data['id_mhs'] ?>" onclick="return confirm('Apa yakin dihapus?')" class="btn btn-danger">Hapus</a>
                        </td>
