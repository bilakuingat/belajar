...
<html lang="en">
    ...
    <body>
        ...
        <main role="main" class="flex-shrink-0">
            <div class="container">
                <h1 class="text-center mt-5">Sebaran covid</h1>
                <!-- Global -->
                <h6>GLOBAL</h6>
                <hr>
                <div class="row mb-5">
                    ...
                    <div class="col-sm-4">
                        <div class="card text-white bg-warning">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h5 class="card-title">Total COVID</h5>
                                        <h1><?= $jumlah_positif_global; ?></h1>
